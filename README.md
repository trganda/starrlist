...
- [AIPentest/CyberStrikeAI](https://github.com/AIPentest/CyberStrikeAI)
...
- [skraft9/vulnerability-research](https://github.com/skraft9/vulnerability-research)
  - Collection of documentation, tools, and tips related to vulnerability research.
- [PortSwigger/http-terminator](https://github.com/PortSwigger/http-terminator)
...
- [piotrkulpinski/open-source-alternatives](https://github.com/piotrkulpinski/open-source-alternatives)
...
- [0xsdeo/AntiDebug_Breaker](https://github.com/0xsdeo/AntiDebug_Breaker)
  - JavaScript Reverse Tools -- JS逆向工具
- [zgjx6/SocialEngineeringDictionaryGenerator](https://github.com/zgjx6/SocialEngineeringDictionaryGenerator)
...
- [philo-groves/codex-attack](https://github.com/philo-groves/codex-attack)
  - An Advanced Cyber Plugin for Codex
- [berabuddies/Semia](https://github.com/berabuddies/Semia)
  - Semia, security audit for AI agent skills.
- [kyverno/kyverno](https://github.com/kyverno/kyverno)
  - Unified Policy as Code
- [sigstore/cosign](https://github.com/sigstore/cosign)
  - Code signing and transparency for containers and binaries
- [openvex/go-vex](https://github.com/openvex/go-vex)
  - Go module to generate and transform VEX documents
- [m-sec-org/BreachWeave](https://github.com/m-sec-org/BreachWeave)
  - 智能渗透Agent Manager/Observer/Solver 多角色架构，基于 pi-mono SDK。
- [flosch/pongo2](https://github.com/flosch/pongo2)
  - Django-syntax like template-engine for Go
- [klscool/ClawPaw](https://github.com/klscool/ClawPaw)
  - Openclaw Android app | Connect your phone to OpenClaw or control via HTTP/SSH tunnel,
- [LFYSec/BACScan](https://github.com/LFYSec/BACScan)
...
- [go-sprout/sprout](https://github.com/go-sprout/sprout)
...
- [Sidenai/sidex](https://github.com/Sidenai/sidex)
  - VS Code rebuilt on Tauri. Same architecture, 96% smaller. Early release.
- [github/vscode-codeql](https://github.com/github/vscode-codeql)
...
- [antgroup/YASA-Engine](https://github.com/antgroup/YASA-Engine)
...
- [advanced-security/codeql-development-mcp-server](https://github.com/advanced-security/codeql-development-mcp-server)
  - LLM <-- MCP --> CodeQL( AST | CFG | CLI | LSP )
- [agentskills/agentskills](https://github.com/agentskills/agentskills)
  - Specification and documentation for Agent Skills
- [tree-sitter/tree-sitter-ql](https://github.com/tree-sitter/tree-sitter-ql)
...
- [Shlomob/ocmonitor-share](https://github.com/Shlomob/ocmonitor-share)
...
- [victorGPT/vibeusage](https://github.com/victorGPT/vibeusage)
...
- [webraybtl/zentaopms_poc](https://github.com/webraybtl/zentaopms_poc)
  - 禅道相关poc
- [zema1/suo5](https://github.com/zema1/suo5)
  - 高性能 HTTP 正向代理工具 | A high-performance http tunneling tool
- [alvarlagerlof/rsc-parser](https://github.com/alvarlagerlof/rsc-parser)
...
- [ejpir/CVE-2025-55182-research](https://github.com/ejpir/CVE-2025-55182-research)
  - CVE-2025-55182 POC
- [westonbrown/Cyber-AutoAgent](https://github.com/westonbrown/Cyber-AutoAgent)
...
- [augurlabs/augur](https://github.com/augurlabs/augur)
...
- [Minima-AI-Inc/minima](https://github.com/Minima-AI-Inc/minima)
...
- [xmdhs/clash2sfa](https://github.com/xmdhs/clash2sfa)
  - 将 Clash.Meta 格式 / 原始格式的订阅链接转换为 sing-box 格式的订阅，用于 SFA
...
- [overspace-labs/CaA](https://github.com/overspace-labs/CaA)
...
- [Micropoor/Micro8](https://github.com/Micropoor/Micro8)
  - Gitbook
- [overspace-labs/HaE](https://github.com/overspace-labs/HaE)
...
- [kmahyyg/ztncui-aio](https://github.com/kmahyyg/ztncui-aio)
  - Your all-in-one Self-Hosted ZeroTier solution for virtual network, Licensed Under GPL v3, version 1.14.2
...
- [buresdv/Cork](https://github.com/buresdv/Cork)
  - [NO AI] Fast GUI for Homebrew written in SwiftUI
...
- [itspatchie/tmux-navigator.nvim](https://github.com/itspatchie/tmux-navigator.nvim)
...
- [tabby-sec/tabby](https://github.com/tabby-sec/tabby)
  - A CAT called tabby ( Code Analysis Tool )
- [github/codeql](https://github.com/github/codeql)
  - CodeQL: the libraries and queries that power security researchers around the world, as well as code scanning in GitHub Advanced Security
- [docker-archive-public/docker.labs](https://github.com/docker-archive-public/docker.labs)
...
- [SummerSec/SpringBootExploit](https://github.com/SummerSec/SpringBootExploit)
