...
- [LoRexxar/Kunlun-M](https://github.com/LoRexxar/Kunlun-M)
  - KunLun-M — Open-source static code analysis for PHP, JavaScript, Python, Java, with AST-based semantic scanning and one-click AI Agent integration (OpenClaw, Codex, Claude Code, Hermes, and more).
